...
class TestCarFunctionality(unittest.TestCase):
    ...
    def test_check_negative_deceleration(self):
        self.car1.start()
        self.car1.decelerate(30)
        self.assertEqual(self.car1.speed,0)

    def test_check_deceleration(self):
        self.car1.start()
        self.car1.accelerate(50)
        self.car1.decelerate(30)
        self.assertEqual(self.car1.speed,20)
